...
export default function BuyModal({ gameState, myId, dispatch }: BuyModalProps) {
  ...
  const canAfford = me.coins >= tile.price;
  ...
  return (
    <div className="overlay open">
      <div className="modal">
        ...
        <div className="info-row"><span>رصيدك الحالي</span><strong>{me.coins.toLocaleString()} جنيه</strong></div>
        <div className="info-row"><span>رصيدك بعد الشراء</span><strong>{(me.coins - tile.price).toLocaleString()} جنيه</strong></div>
